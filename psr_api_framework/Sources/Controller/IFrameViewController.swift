...
public class IFrameViewController: UIViewController, EasyTipViewDelegate
{
    ...
    static public func instantiate() -> IFrameViewController?
    {
        ...
        theIframe = UIStoryboard(name: "PayDunyaPSR", bundle: frameworkBundle).instantiateViewController(withIdentifier: "\(IFrameViewController.self)") as? IFrameViewController
...
protocol backToApp: class {
    func back_to_app(vcontroller: IFrameViewController)
}
...
public var theIframe: IFrameViewController!

@discardableResult
public func customActivityIndicatory(_ viewContainer: UIView, startAnimate: Bool? = true) -> UIActivityIndicatorView
{
